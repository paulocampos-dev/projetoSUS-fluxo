        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (step.index < thread.length) {
                ...
                if (line.collect && line.action !== 'beginDialog') {
                    ...
                    if (line.type || line.text || line.object || line.attachments || line.attachment || line.blocks || (line.channelData && Object.keys(line.channelData).length)) {
    ...
    makeOutgoing(dc, line, vars) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (line.quick_replies && typeof (line.quick_replies) !== 'function') {
                ...
                outgoing = JSON.parse(JSON.stringify(botbuilder_1.MessageFactory.text(text)));
            }
            ...
            if (outgoing.text && line.text) {
                
                outgoing.text = mustache.render(outgoing.text, { vars: vars });
                
            }
            if (outgoing.text && line.object) {
                outgoing.text.body = mustache.render(outgoing.text.body, { vars: vars });
